...
def main():
    ...
    # Get 1H test features. If 'is_day' missing, resample.
    if 'is_day' not in test_1h_results.columns:
        ...
        test_1h_results['is_day'] = test_1h_features['is_day']
    else:
        test_1h_features = test_1h_results.copy()
    ...
    test_1h_results['pred_scen_a'] = test_15_results.set_index('date_utc').resample('1h')['pred_native_15'].mean().values
